    ...
    children: [
      {
        name: 'home',
        path: 'home',
        component: () => import('../pages/admin/dashboard/Home.vue'),
      },
      {
        name: 'statistics',
        path: 'statistics',
